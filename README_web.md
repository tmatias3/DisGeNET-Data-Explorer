...
> Infrastructure Note:
> This project was developed as part of a Database Systems university course, connected to an institutional SQL Server Data Warehouse. As the academic semester has concluded, the live database is no longer accessible. The source code is provided here to demonstrate the ETL logic, system architecture, and UI/UX design implementation.
